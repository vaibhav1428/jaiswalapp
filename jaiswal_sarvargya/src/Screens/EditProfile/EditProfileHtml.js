...
import { CREATESHOP, EDITMETRIMONIAL } from '../../Nevigation/RoutesName';
import CachedImage from '../../Components/FaseImage/Index';
import I18n from 'i18n-js';



const EditProfileHtml = ({onchange,error,isloading,onsubmit,form,imageupload,image,phoneno,mycity,mystate}) => {
    ...
    return (
        <ScrollView >
            ...
            <View style={{alignSelf:'center',marginTop:heightPercentageToDP('3%')}}>             
                <Input labelStyle={{color:Customclr.dark ,fontSize:heightPercentageToDP('2.8%')}} 
                       placeholderTextColor={Customclr.dark} 
                        ...
                        placeholder={I18n.t('Enter_Your_Full_Name')}  label={I18n.t('Full_Name')}   
                ...
                <Input labelStyle={{color:Customclr.dark ,fontSize:heightPercentageToDP('2.8%')}} 
                        ...
                        containerStyle={{width:widthPercentageToDP('95%'),marginTop:heightPercentageToDP('1.8%')}}  
                        inputContainerStyle={{borderColor: Customclr.dark}} 
                        placeholder={I18n.t('Enter_Your_Email_address')}  label={I18n.t('Email')} 
                ...
                <Input labelStyle={{color:Customclr.dark ,fontSize:heightPercentageToDP('2.8%')}} 
                        ...
                        containerStyle={{width:widthPercentageToDP('95%'),marginTop:heightPercentageToDP('1.8%') }}
                        inputContainerStyle={{borderColor: Customclr.dark}}
                        // placeholder={I18n.t('Work')}
                         label={I18n.t('Work')}  multiline={true}
                        onChangeText={(value)=>{onchange({name:"work",value })}}  
                        value={form.work||""}
            ...
            <View style={styles.mypicker}>
                <View style={{display:'flex',flexDirection:'row'}}>
                <Text style={styles.pickerlabel}>{I18n.t('MaterialStatus')}</Text>
                </View>
            ...
            <View style={styles.mypicker}>
                <View style={{display:'flex',flexDirection:'row'}}>
                <Text style={styles.pickerlabel}>{I18n.t('Job_Status')}</Text>
                </View>
            ...
            <View style={{ marginTop:heightPercentageToDP('1%'),width:widthPercentageToDP('90%'),alignSelf:'center'}}>
                ...
                <Text>
                    ...
                    {labelstate||mystate|| "Please Select state"}
                </Text> 
                </Pressable> 
                </View>         
            ...
            <View style={{ marginTop:heightPercentageToDP('1%'),width:widthPercentageToDP('90%'),alignSelf:'center'}}>
                ...
                <Text>                   
                    { labelcity||mycity|| "Please Select city"} 
                </Text> 
                </Pressable>
                </View>         
            ...
            <View style={styles.mypicker}>
                <View style={{display:'flex',flexDirection:'row'}}>
                <Text style={{  fontSize:heightPercentageToDP('2%'), fontWeight:'700',marginBottom:heightPercentageToDP('1%')}}>{I18n.t('do_you_want_matrimony')}</Text>
                ...
                <RNPickerSelect
                     ...
                     style={{ inputAndroid: { color: 'black' } }}
                     items={[
                        { label:I18n.t('yes'), value: '1'   , key:'1' },
                        { label: I18n.t('no'), value: '2' , key:'2' },
                        ]}
                />
                ...
                <View style={styles.mypicker}>
                <View style={{display:'flex',flexDirection:'row'}}>
                <Text style={{  fontSize:heightPercentageToDP('2%'), fontWeight:'700',marginBottom:heightPercentageToDP('1%')}}>{I18n.t('do_you_want_directory')}</Text>
            ...
            <Pressable onPress={showDatePicker} style={{flexDirection:'row',alignItems:'center'}}>
                ...
                {
                form.metrimonyshare == 1 || IsMetrimonyshare == 1 ?
                //   <TouchableOpacity onPress={()=>{navigation.navigate(EDITMETRIMONIAL ,{phoneno:phoneno}) }} style={{display:'flex',flexDirection:'row',justifyContent:'space-between'}}>
                //       <Text  style={{fontWeight:'600',fontSize:heightPercentageToDP('3%'),color:Customclr.blue,marginLeft:widthPercentageToDP('2%')}}>
                //          {I18n.t('Edit_Profile_For_Matrimony')}
                //       </Text>

                //       <View>
                //           <Icon name="create" color={Customclr.blue} size={heightPercentageToDP('3%')}/>
                //       </View>
                //   </TouchableOpacity>
                ...
                <Button buttonStyle={{width:widthPercentageToDP('90%'),
                backgroundColor:Customclr.blue,alignSelf:'center',marginBottom:heightPercentageToDP('2%'),height:heightPercentageToDP('7%')}}
                title= {I18n.t('Edit_Profile_For_Matrimony')} onPress={()=>{navigation.navigate(EDITMETRIMONIAL ,{phoneno:phoneno}) }} 
                icon={{
                    name: 'arrow-right',
                    type: 'font-awesome',
                    size: 20,
                ...
                <Button buttonStyle={{width:widthPercentageToDP('90%'),
                backgroundColor:Customclr.green,alignSelf:'center',marginBottom:heightPercentageToDP('2%'),height:heightPercentageToDP('7%')}}
                title= {'Create your shop with us'} onPress={()=>{navigation.navigate(CREATESHOP ,{phoneno:phoneno}) }} 
                icon={{
                    name: 'arrow-right',
                    type: 'font-awesome',
                    size: 20,
...
export default EditProfileHtml
