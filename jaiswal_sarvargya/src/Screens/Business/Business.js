...
import BusinessHtml from './BusinessHtml';
...
const Business = () => {
  ...
  const [iscategoryid,setcategoryid] = React.useState('');
    ...
    const filtereddata = (stateft,cityft) =>{
         axiosInstance.post('/all_business',{
            state:stateft,
            city:cityft,
            filteruser: '',
        }).then((res) =>{
        ...
        <>
         {
                ...
                <SafeAreaView style={{flex:1}}>
                    ...
                    <View style={styles.filtercontainer}>
                        ...
                        <View style={{marginLeft:widthPercentageToDP('5%')}}>
                            <TouchableOpacity  onPress={togglecategoryeOverlay}>
                                <Text style={styles.filtertext}>
                                { labelcategory || 'Category'} {<Icon  name='sort-down'  type='font-awesome'  color={Customclr.orangeshade0}/>}
                    ...
                    onChangeText={(val)=>{ searchfilterdata(state,city,val.toUpperCase()) ,setvalue(val.toUpperCase())}}
                    value={isvalue}
