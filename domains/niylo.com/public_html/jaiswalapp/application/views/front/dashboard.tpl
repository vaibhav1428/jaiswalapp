...
<head>
  ...
  <title>Jaiswal Sarwarigy</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <link href="<?php  echo base_url()   ?><?php  echo $jaiswaldata[0]['txt_site_logo']  ?>" rel="icon">
  <link href="<?php  echo base_url()   ?><?php  echo $jaiswaldata[0]['txt_site_logo']  ?>" rel="apple-touch-icon">
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="logo">
		...
		<?php  echo $jaiswaldata[0]['txt_meta_title']  ?>
        ...
        <div class="col-12 hero-text-image">
          <div class="row">
            ...
            <div class="col-lg-4 iphone-wrap">
              <img src="<?php  echo base_url()   ?>assets/front/img/phone_1.png" alt="Image" class="phone-1" data-aos="fade-right">
              <img src="<?php  echo base_url()   ?>assets/front/img/phone_2.png" alt="Image" class="phone-2" data-aos="fade-right" data-aos-delay="200">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5" data-aos="fade">
          <div class="col-md-6 mb-5">
            <img src="<?php  echo base_url()   ?>assets/front/img/undraw_svg_1.svg" alt="Image" class="img-fluid">
          </div>
        </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6" data-aos="fade-left">
            <img src="<?php  echo base_url()   ?>assets/front/img/undraw_svg_2.svg" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6" data-aos="fade-right">
            <img src="<?php  echo base_url()   ?>assets/front/img/undraw_svg_3.svg" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="review text-center">
                    ...
                    <p class="review-user">
                      <img src="<?php  echo base_url()   ?>assets/front/img/person_1.jpg" alt="Image" class="img-fluid rounded-circle mb-3">
                      <span class="d-block">
                ...
                <div class="swiper-slide">
                  <div class="review text-center">
                    ...
                    <p class="review-user">
                      <img src="<?php  echo base_url()   ?>assets/front/img/person_2.jpg" alt="Image" class="img-fluid rounded-circle mb-3">
                      <span class="d-block">
                ...
                <div class="swiper-slide">
                  <div class="review text-center">
                    ...
                    <p class="review-user">
                      <img src="<?php  echo base_url()   ?>assets/front/img/person_3.jpg" alt="Image" class="img-fluid rounded-circle mb-3">
                      <span class="d-block">
      ...
      <div class="row justify-content-center text-center">
        <div class="col-md-7">
          ...
          <div class="credits">
            ...
            Designed by <a href="https://bootstrapmade.com/">Jaiswal Sarwarigya</a>
          </div>
        </div>
      </div>
