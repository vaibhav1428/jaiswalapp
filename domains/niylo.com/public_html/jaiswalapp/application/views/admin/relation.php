			...
			<div class="row">
				<div class="col-lg-12 col-md-12  col-sm-12 ">
					<div class="collapse mt-4" id="collapseExample">
						...
						<form action="<?php echo base_url("Informationajax/relationinst")  ?>" method="post" id="frmdata" class="insform">
						...
						<!---------FIELD WILL BE HERE    -->
							...
							<input type="text" class="form-control" id="relation" aria-describedby="relation_error" placeholder="Enter Relation" name="relation">
							<small id="relation_error" class="form-text text-muted"></small>
							</div>
							<!------------>
							<div class=" col-lg-12 col-md-12  col-sm-12">
									...
									<div class="card-body "> 
											<table id="tblData" class="table table-striped overflow-auto" style="width:100%">  
												 ...
												 foreach($result as $res){
													...
													<button class="<?php  echo $style  ?>" onclick="statuschange(<?php echo $res['id'] ?>,'relation')">  <?php  echo $text  ?>
													</button>
													</td>
													<td style="text-align: center;">
													...
													<td style="text-align: center;">
													<button class="btn btn-info" onclick="editrelation(<?php echo $res['id'] ?>)"> <i class="far fa-edit"></i>
													</button>
													</td>
													<!------deleterequest('ID WILL BE HERE ','DATABASE NAME ')------->
													<td style="text-align: center;">
													<button class="btn btn-danger" onclick="deleterequest(<?php echo $res['id'] ?>,'relation')"><i class="far fa-trash-alt"></i>
													</button>
